...
public class Radar {
    ...
    private static final float PAD_Y = 31;
    private static final int RADAR_COLOR = Color.argb(100, 0, 0, 0);
    private static final int RADAR_COLOR2 = Color.argb(100, 0, 80, 0);
    private static final int RADAR_COLOR3 = Color.argb(120, 10, 200, 10);
    ...
    private static PaintablePosition circleContainer2 = null;
    private static PaintablePosition circleContainer3 = null;
    private static PaintablePosition circleContainer4 = null;
    private static PaintablePosition circleContainer5 = null;
    ...
    private void drawRadarCircle(Canvas canvas) {
        ...
        if (circleContainer2 == null) {
            PaintableCircle paintableCircle2 = new PaintableCircle(RADAR_COLOR2, RADIUS-5, true);
            circleContainer2 = new PaintablePosition(paintableCircle2, PAD_X + RADIUS, PAD_Y + RADIUS, 0, 1);
        }
        
        circleContainer2.paint(canvas);
        
        if (circleContainer3 == null) {
            PaintableCircle paintableCircle2 = new PaintableCircle(RADAR_COLOR3, RADIUS-20, false);
            circleContainer3 = new PaintablePosition(paintableCircle2, PAD_X + RADIUS, PAD_Y + RADIUS, 0, 1);
        }
        
        circleContainer3.paint(canvas);
        
        if (circleContainer4 == null) {
            PaintableCircle paintableCircle2 = new PaintableCircle(RADAR_COLOR3, RADIUS-55, false);
            circleContainer4 = new PaintablePosition(paintableCircle2, PAD_X + RADIUS, PAD_Y + RADIUS, 0, 1);
        }
        
        circleContainer4.paint(canvas);
        
        if (circleContainer5 == null) {
            PaintableCircle paintableCircle2 = new PaintableCircle(RADAR_COLOR3, RADIUS-90, false);
            circleContainer5 = new PaintablePosition(paintableCircle2, PAD_X + RADIUS, PAD_Y + RADIUS, 0, 1);
        }
        
        circleContainer5.paint(canvas);
    }
    ...
    private void drawRadarText(Canvas canvas) {
        ...
        // Azimuth text
        radarText(canvas, RADAR_TXT.toString(), (PAD_X+RADIUS), (PAD_Y)-18, true);

        // Zoom text
        radarText(canvas, formatDist(ARData.getRadius() * 1000), (PAD_X+RADIUS), (PAD_Y+(RADIUS*2)+13), false);
    }
